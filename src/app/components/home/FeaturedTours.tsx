...
const FeaturedTours: React.FC = () => {
  const tours = [
    {
      icon: <GiDesert className="w-full h-full" />,
    ...
    {
      icon: <FaCity className="w-full h-full" />,
    ...
    {
      icon: <FaMountain className="w-full h-full" />,
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-amber-700 max-w-2xl mx-auto">
            Discover our handpicked selection of unforgettable Moroccan experiences
          </p>
        </div>
